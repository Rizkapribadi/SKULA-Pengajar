...
<head>
   ...
   <meta name="csrf-token" content="{{ csrf_token() }}">
    <link rel="icon" href="{{ asset('asset/skula.png') }}" type="image/x-icon">
    <link href="{{ asset('asset/plugins/font-awesome/fonts/font-roboto.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('asset/plugins/font-awesome/fonts/roboto-subset.css') }}" rel="stylesheet" type="text/css">
	<link href="{{ asset('asset/plugins/font-awesome/fonts/material-icon.css') }}" rel="stylesheet" type="text/css">
	<link rel="stylesheet" href="{{ URL ::asset('js/font-awesome/font-awesome-4.3.0/css/font-awesome.min.css') }}">
    ...
    <link href="{{ asset('asset/plugins/light-gallery/css/lightgallery.css') }}" rel="stylesheet">
    <link href="{{ asset('asset/css/style.css') }}" rel="stylesheet">
    <link href="{{ asset('asset/css/stylus.css') }}" rel="stylesheet">
    <link href="{{ asset('asset/css/themes/all-themes.css') }}" rel="stylesheet" />
</head>
<body class="theme-red is-closed">
    ...
    <div class="overlay"></div>
     <div class="search-bar">
        ...
        <input type="text" name="q" placeholder="CARI MATERI"id="autocomplete-input" class="autocomplete">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                <a href="{{ route('pelajaran.index') }}"><img src="{{ asset('asset/skulaskinless.png') }}" width="65" height="48" alt="User" /></a>
            </div>
             <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                 <li class="dropdown">
						...
						<div class="user-info">
						 <div class="image" data-toggle="tooltip" data-placement="right" title="cari materi">
						 <a href="javascript:void(0);" class="js-search" data-close="true">
                           <img src="{{ asset('asset/images/io.png') }}" width="33" height="33" alt="User" />
						   </a>
						   </div>
						   </div>
                        </a>	
					...
					<li class="dropdown">
						...
						<div class="user-info" >
						 <div class="image" data-toggle="tooltip" data-placement="right" title="menu pelajaran">					
                           &nbsp;  &nbsp;<img src="{{ asset('asset/images/pelajaran.png') }}" width="33" height="33" alt="User" />					   
						   </div>					   
						   </div>
                        </a>
                    </li>  
					<li class="dropdown">
                        <a href="{{ route('trash') }}">
						<div class="user-info" >
						 <div class="image" data-toggle="tooltip" data-placement="right" title="menu archive">					
                        &nbsp;<img src="{{ asset('asset/images/box.png') }}" width="35" height="35" alt="User" />					   
						   </div>					   
						   </div>
                        </a>
                    </li>
                         <li class="dropdown">
                        <a href="{{ route('action-page') }}">
                        <div class="user-info" >
                         <div class="image" data-toggle="tooltip" data-placement="right" title="impor dan ekspor materi">                    
                           <img src="{{ asset('asset/images/download.png') }}" width="38" height="38" alt="User" />                     
                           </div>                      
                           </div>
                        </a>
                    </li>
 ...
 <section class="content">
   <div class="container-fluid">         
    ...
    <script src="{{ asset('asset/plugins/light-gallery/js/lightgallery-all.js') }}"></script>
    <script src="{{ asset('asset/plugins/node-waves/waves.js') }}"></script>
    <script src="{{ asset('asset/plugins/waitme/waitMe.js') }}"></script>
